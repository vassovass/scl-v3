...
- **SEO-Optimized Favicon System** - Modular, theme-aware favicon infrastructure
  - **Icon Design** - Emoji-style walking shoes (one flat-footed, one arched mid-step)
  - **Theme-Aware** - Uses CSS media queries to serve correct icon for user's color scheme
    - Dark mode: Sky-blue icons with sparkles for visibility
    - Light mode: Deep-blue icons for contrast
  - **All Required Sizes Generated**:
    - `icon-512-dark.png` / `icon-512-light.png` - Source icons
    - `icon-192.png` / `icon-192-light.png` - PWA icons
    - `apple-touch-icon.png` / `apple-touch-icon-light.png` - iOS
    - `favicon-32x32.png` / `favicon-16x16.png` (+ light variants)
  - **SEO Optimizations**:
    - Theme-color meta tags for light/dark modes
    - Complete `manifest.json` with PWA shortcuts and categories
    - Apple touch icon for iOS home screen
  - **Files Updated**:
    - `src/app/layout.tsx` - Theme-aware favicon link tags with media queries
    - `public/manifest.json` - Updated with all icon references and shortcuts
  - **Database Schema** (`migrations/20260110144500_notification_infrastructure.sql`)
    - `notification_types` - Reference table for all notification types
    - `notification_settings_global` - SuperAdmin platform defaults
    - `notification_settings_league` - Per-league settings (Owner/Admin)
