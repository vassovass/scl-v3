...
export default function ClaimPage({ params }: ClaimPageProps) {
    ...
    if (error) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-mesh">
                <div className="max-w-md w-full mx-4 p-6 rounded-lg bg-slate-900/80 border border-rose-500/30 text-center">
                    ...
                    <Link
                        href="/dashboard"
                        className="inline-block px-4 py-2 rounded-lg bg-sky-600 text-white hover:bg-sky-500 transition"
                    >
                        Go to Dashboard
                    </Link>
                </div>
    ...
    return (
        <>
            ...
            <div className="min-h-screen flex items-center justify-center bg-gradient-mesh p-4">
                <div className="max-w-md w-full rounded-lg bg-slate-900/80 border border-sky-500/30 overflow-hidden">
                    {/* Header */}
                    <div className="bg-sky-500/10 p-6 text-center border-b border-sky-500/20">
                    ...
                    <div className="p-6 space-y-4">
                        <div className="bg-slate-800/50 rounded-lg p-4">
                            <div className="flex items-center justify-between mb-2">
                                <span className="text-sm text-slate-400">Proxy Name</span>
                        ...
                        <button
                            ...
                            disabled={claiming}
                            className="w-full py-3 rounded-lg bg-sky-600 text-white font-semibold hover:bg-sky-500 transition disabled:opacity-50"
                        >
