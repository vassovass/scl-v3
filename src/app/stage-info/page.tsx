...
export default function StageInfoPage() {
    ...
    const stageColors: Record<string, { bg: string; border: string; text: string; glow: string }> = {
        ...
        'alpha': { bg: 'bg-blue-900/10', border: 'border-blue-600/30', text: 'text-blue-400', glow: 'bg-blue-500' },
        'beta': { bg: 'bg-amber-900/10', border: 'border-amber-600/30', text: 'text-amber-400', glow: 'bg-amber-500' },
